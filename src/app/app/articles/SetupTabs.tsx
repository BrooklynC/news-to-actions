...
export function SetupTabs({ topicsContent, personasContent }: Props) {
  ...
  const linkClass = (active: boolean) =>
    `inline-flex min-h-[44px] items-center justify-center rounded-full px-4 py-2 text-sm font-medium transition-colors ${
      active
  ...
  return (
    <div className="space-y-4">
      <nav className="flex flex-wrap gap-2 border-b border-stone-200 pb-3 dark:border-stone-700">
        <button
          type="button"
